import psCimModule from '@microsoft/windows-admin-center-sdk/tools/gulp-ps-cim';
import psCodeModule from '@microsoft/windows-admin-center-sdk/tools/gulp-ps-code';
import psManifestModule from '@microsoft/windows-admin-center-sdk/tools/gulp-ps-manifest';
import psModuleModule from '@microsoft/windows-admin-center-sdk/tools/gulp-ps-module';
import psResjsonModule from '@microsoft/windows-admin-center-sdk/tools/gulp-ps-resjson';
...
export module PowerShellModule {
    ...
    function powershellModule() {
        ...
        return src(powerShellModulePaths)
            ...
            .pipe(dest('dist-ps/powershell-module/' + config.powershell.name));
    }
