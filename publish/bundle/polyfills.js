...
module.exports = __webpack_require__(/*! C:\Users\sbrookes\zNode\zPROSET_NEW\src\polyfills.ts */"hN/g");
...
/***/ "118y":
/*!*********************************************************************************!*\
  !*** ./node_modules/@microsoft/windows-admin-center-sdk/core/base/utilities.js ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
(function (MsftSme) {
    ...
    function stableSort(array, compare) {
        const array2 = array.map((v, i) => { return { i: i, v: v }; });
        array2.sort((a, b) => {
    ...
    function getEnumArray(tsEnumeration, sort) {
        ...
        return sort ? retVal.sort((a, b) => { return a.value - b.value; }) : retVal;
    }
        ...
        if (!isObject(value)) {
            ...
            */
            ...
            if (value instanceof Date) {
                ...
                dest[propName] = array_isArray(value) ? [...value] : Object.assign({}, value);
            }
        }
 ...
 */
    ...
    function setValue(object, path, value) {
        // call our internal get value function
        return setValueInternal(object, path, value, true);
    }
    MsftSme.setValue = setValue;
    //#endregion Object
    /**
     * Preserves any existing document selection while performing an action that temporarily changes selection
     * @param action The action to take
     */
    function preserveDocumentSelection(action) {
    ...
    MsftSme.preserveDocumentSelection = preserveDocumentSelection;
    /**
    ...
    MsftSme.copyToClipboard = copyToClipboard;
    ;
    //#region String
    /**
    ...
    function replaceMany(input, replacementMap) {
        ...
        return input.replace(regex, (match) => replacementMap[match]);
    }
        ...
        if (input && separator && limit) {
            ...
            while (true) {
                if (retVal.length >= limit || // only one spot left in the array. push remaining string into array and exit.
                    (indexOf = string_indexOf(input, separator, startIndex)) < 0) // // no more separators left. push remaining string into array and exit.
                 {
     ...
     */
    function trimStart(input, ...values) {
        input = input || "";
        while (input) {
            let match = values.first((value) => {
    ...
    function pathJoin(pathSeparator, pathComponents) {
        ...
        let output = "";
        array_forEach((pathComponents || []), (current) => {
    ...
    MsftSme.getSafeOrigin = getSafeOrigin;
    //#endregion Browser
    //#region Uri
    /**
     ...
     * @param parameterName
     */
    function getLocationSearchParameter(parameterName) {
    ...
    MsftSme.getLocationSearchParameter = getLocationSearchParameter;
    /**
     ...
     */
    function getUriAuthority(uri, includePort = true) {
    ...
    array_forEach(["boolean", undefinedType, numberType, stringType, "symbol"], (item) => { primitiveTypes[item] = true; });
    /**
    ...
    function polyfill(type, fills, force) {
        ...
        forEachKey(fills, (funcName, func) => {
    ...
    function lowerCaseAllStrings(source) {
        if (source) {
            ...
            if (type === "string") {
                ...
                return source.map((arrayValue) => lowerCaseAllStrings(arrayValue));
            }
            else if (type === "object") {
                const sourceAsStringMap = source;
    ...
    function sideLoadRead() {
        ...
        let global = window;
        let length = global.localStorage.length;
        let keys = [];
        for (var index = 0; index < length; index++) {
            let key = global.localStorage.key(index);
        ...
        let data = {};
        for (var key of keys) {
            let item = JSON.parse(global.localStorage.getItem(key));
            // trim last "/"
            if (item.origin[item.origin.length - 1] === '/') {
                item.origin = item.origin.substr(0, item.origin.length - 1);
            }
    ...
    function consoleDebugRead() {
        ...
        let data = JSON.parse(global.localStorage.getItem(consoleDebugKey));
        if (data && data.level) {
            return data.level;
        }
        // fallback again to whatever was passed into the Init call
        let smeWindow = global;
    ...
    function getPerformanceProfile() {
        const profile = localStorage.getItem(performanceProfileStorageKey);
        return profile === "1";
    }
    MsftSme.getPerformanceProfile = getPerformanceProfile;
    function setPerformanceProfile(profile) {
        if (profile) {
            localStorage.setItem(performanceProfileStorageKey, "1");
        }
        else {
            localStorage.removeItem(performanceProfileStorageKey);
        }
    }
    MsftSme.setPerformanceProfile = setPerformanceProfile;
    ...
    function getDeveloperGuide() {
        ...
        if (experiments.some(experiment => experiment === developerGuideExperimentKey)) {
            ...
            const developerGuide = localStorage.getItem(developerGuideStorageKey);
            return developerGuide === "1";
        }
    }
    MsftSme.getDeveloperGuide = getDeveloperGuide;
    function setDeveloperGuide(developerGuide) {
        if (developerGuide) {
            localStorage.setItem(developerGuideStorageKey, "1");
        }
        else {
            localStorage.removeItem(developerGuideStorageKey);
        }
    }
    MsftSme.setDeveloperGuide = setDeveloperGuide;
    ...
    function experimentsRead() {
        ...
        // then we fallback to what is saved in localStorage
        let data = global.localStorage.getItem(experimentsKey);
    ...
    function experiments(value) {
        if (Array.isArray(value)) {
            global.localStorage.setItem(experimentsKey, value.join(experimentsSplitChar));
            global.MsftSme.Init.experiments = value;
            return value;
        }
        return experimentsRead();
    }
    MsftSme.experiments = experiments;
    /**
     * Reset all experiment settings on current loaded domain.*
     */
    function experimentsReset() {
        global.localStorage.removeItem(experimentsKey);
    }
    MsftSme.experimentsReset = experimentsReset;
    /**
     ...
     */
    function isExperimentEnabled(key, shellExperiment = false) {
    ...
    function getStrings() {
        ...
        return MsftSme.self().Resources.strings;
    }
    MsftSme.getStrings = getStrings;
    /**
    ...
    function self() {
        ...
        if (!self.Host) {
            ...
            let electron = window['require'] ? window['require']('electron') : null;
            self.Host = {
                isElectron: !!electron,
                isWeb: !electron,
                electron: electron,
    ...
    MsftSme.isExtension = isExtension;
    /**
    ...
    MsftSme.entryPointType = entryPointType;
    /**
...
`);
    ...
    MsftSme.listVersions = listVersions;
    /** array.ts */
    polyfill(Array, {
...
/***/ "226e":
/*!***************************************************************************************!*\
  !*** ./node_modules/@microsoft/windows-admin-center-sdk/core/base/polyfills/array.js ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "2nU+":
/*!****************************************************************************************!*\
  !*** ./node_modules/@microsoft/windows-admin-center-sdk/core/base/polyfills/string.js ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "5HEx":
/*!***********************************************************************************!*\
  !*** ./node_modules/@microsoft/windows-admin-center-sdk/core/base/environment.js ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "hK4m":
/*!****************************************************************************!*\
  !*** ./node_modules/@microsoft/windows-admin-center-sdk/core/polyfills.js ***!
  \****************************************************************************/
/*! no exports provided */
...
/* harmony import */ var _base_environment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./base/environment */ "5HEx");
/* harmony import */ var _base_environment__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_base_environment__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _base_utilities__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./base/utilities */ "118y");
/* harmony import */ var _base_utilities__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_base_utilities__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _base_polyfills_array__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./base/polyfills/array */ "226e");
/* harmony import */ var _base_polyfills_array__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_base_polyfills_array__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _base_polyfills_string__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./base/polyfills/string */ "2nU+");
/* harmony import */ var _base_polyfills_string__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_base_polyfills_string__WEBPACK_IMPORTED_MODULE_3__);
